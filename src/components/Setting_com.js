  ...
  return (
    <>
      <div className="flex justify-between">
        <h1 className="text-[#0A0D26] ml-16 text-[28px] font-bold leading-8 pt-2">
          Settings
        </h1>
          ...
          <div className="">
            <div className="flex w-full border-b">
              <div className="flex  space-x-3">
                <button
                  className={`w-full text-[#4D4D4D] text-[17px] font-normal py-[8px] px-[16px] leading-5 border-b-2 ${
                    activeTab === "profile"
                ...
                <button
                  className={`w-full text-[17px] font-normal py-[8px] px-[16px] leading-5 border-b-2 ${
                    activeTab === "security"
                      ? "border-[#151F6D] text-[#151F6D] "
                      : "border-transparent text-[#4D4D4D]"
                  } hover:border-[#05081e]`}
            ...
            <div className="">
              {activeTab === "profile" ? (
                ...
                <div className="md:flex my-5 ">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="flex flex-col">
                      <label className="text-[#4D4D4D] mb-2 text-[16px] leading-5 font-medium">
                        First Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="flex justify-end mt-5 sm:w-[204%]">
                      <button className="bg-[#151F6D]  w-[175px] text-white py-[14px] px-[32px] rounded-xl">
                        Save Changes
                      </button>
                    </div>
                    </div>
                ...
                <div className="sm:w-full md:w-[339px]">
                  <h2 className="text-[#000000] text-[28px] font-bold leading-9 my-5">
                    Change Password
                  </h2>
                  <div className="flex flex-col my-4">
                    <label className="text-[#4D4D4D] mb-2 text-[16px] leading-4 font-medium">
                      Old Password
                    </label>
                    <input
                      type="password"
                  ...
                  <div className="flex justify-end">
                    <button className="bg-[#151F6D] text-white py-[14px] px-[32px] rounded-xl">
                      Change Password
                    </button>
                  </div>
                </div>
