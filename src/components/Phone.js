...
const Phone = () => {
  ...
  <h1 className="text-[#0A0D26] ml-16 sm:text-[20px] md:text-[28px] font-bold leading-8 pt-2">Phone Numbers</h1>
...
<div className="bg-white  h-auto rounded-xl p-6 mt-5">
    ...
    <table className="min-w-full">
        <thead>
          <tr>
            ...
            <th className="text-[#151F6D] text-[16px] leading-5 font-bold w-[224px] p-3 text-start">Agent</th>
        ...
        <tbody>
          <tr>
            ...
            <td className="text-[#0A0D26] text-[16px] font-normal leading-5 w-[224px] p-3 text-start">In-Bound</td>
          ...
          <tr>
            ...
            <td className="text-[#0A0D26] text-[16px] font-normal leading-5 w-[224px] p-3 text-start">Out-Bound</td>
            <td className="text-[#0A0D26] text-[16px] font-normal leading-5 w-[224px] p-3 text-start">Agent Name</td>
            <td className="text-[#0A0D26] text-[16px] font-normal leading-5 w-[224px] p-3 flex justify-center items-center"><Image src="/edit.svg" width={24} height={24} alt="Close" onClick={openModal} /></td>
          </tr>
    ...
    {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <h1 className='text-[#424D5B] text-[20px] leading-6 font-semibold mb-5'>New Phone / Edit Phone</h1>
            <button
            ...
            <div className='flex flex-col my-3'>
                  ...
                  <input type="text" placeholder='Enter Phone' className='bg-[#F3F3FC] py-[14px] px-[32px] rounded-xl' />
            ...
            <div className='flex flex-col my-3'>
                    <label className="text-[#0A0D26] mb-2 text-[16px] leading-5 font-medium">Agent</label>
                   <div className='bg-[#F3F3FC] py-[14px] pl-[45px] pr-[32px] rounded-xl'>
                   <select name="" id="" className='bg-[#F3F3FC] w-full -ml-2 outline-none'>
                      <option value="" disabled selected>Select</option>
